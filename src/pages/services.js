...
import { FiServer, FiTool, FiShield, FiActivity } from 'react-icons/fi';
      ...
      services: [
        {
          ...
          icon: <FiServer size={32} className="text-blue-500 dark:text-blue-400" />,
        ...
        },
        {
          ...
          icon: <FiTool size={32} className="text-gray-600 dark:text-gray-400" />,
        ...
        },
        {
          ...
          icon: <FiShield size={32} className="text-red-500 dark:text-red-400" />,
        ...
        },
        {
          ...
          icon: <FiActivity size={32} className="text-green-500 dark:text-green-400" />,
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {t.services.map((service, index) => (
            <div 
              key={index} 
              className={`bg-white dark:bg-[#111] border border-gray-200 dark:border-white/10 rounded-3xl p-8 hover:border-gray-300 dark:hover:border-white/30 transition-all shadow-sm dark:shadow-none`}
            >
